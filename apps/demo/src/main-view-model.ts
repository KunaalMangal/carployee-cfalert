...
import { CFAlertDialog, DialogOptions, CFAlertGravity, CFAlertActionAlignment, CFAlertActionStyle, CFAlertStyle } from '@nativescript/cfalert';
export class MainViewModel extends Observable {
	...
	public cfalertDialog: CFAlertDialog = new CFAlertDialog();
	...
	showBottomSheet = function () {
		...
		this.cfalertDialog.show(options).then((res) => {
